      ...
      <div className="bg-white rounded-lg border border-slate-200 p-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-sm text-slate-500">
            <span className="font-mono text-cyan-700">{xpToNextLevel} XP</span>{' '}
            to Level {learningStats.level + 1}
          </div>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-8">
          <div className="p-6 bg-cyan-50 rounded-lg border border-cyan-200">
            ...
            <p className="font-mono text-4xl text-cyan-900">
              {learningStats.level}
            </p>
          </div>
          ...
          <div className="p-6 bg-slate-50 rounded-lg border border-slate-200">
            ...
            <p className="font-mono text-4xl text-slate-900">
              {learningStats.xp.toLocaleString()}
            </p>
          </div>
          ...
          <div className="p-6 bg-green-50 rounded-lg border border-green-200">
            ...
            <p className="font-mono text-4xl text-green-900">
              {lessonsCompleted}
            </p>
          </div>
        </div>
        ...
        <div>
          <div className="flex justify-between text-sm mb-2">
            <span className="text-slate-600">
              Progress to Level {learningStats.level + 1}
            </span>
