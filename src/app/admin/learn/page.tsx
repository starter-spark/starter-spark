        ...
        <div className="rounded-lg border border-slate-200 bg-white p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-mono text-2xl font-bold text-slate-900">{totalCourses}</p>
            </div>
          </div>
        </div>
        <div className="rounded-lg border border-slate-200 bg-white p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-mono text-2xl font-bold text-green-600">{publishedCourses}</p>
            </div>
          </div>
        </div>
        <div className="rounded-lg border border-slate-200 bg-white p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-mono text-2xl font-bold text-slate-900">{totalModules}</p>
            </div>
          </div>
        </div>
        <div className="rounded-lg border border-slate-200 bg-white p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-mono text-2xl font-bold text-slate-900">{totalLessons}</p>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <TableRow key={course.id}>
                    <TableCell>
                      <div>
                        ...
                        {course.slug && (
                          <code className="text-xs text-slate-500">{course.slug}</code>
                        )}
                      </div>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell className="font-mono text-sm">{lessonCount}</TableCell>
