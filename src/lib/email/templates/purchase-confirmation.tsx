    ...
    <BaseLayout preview={previewText}>
      ...
      <Section style={nextStepsSection}>
        ...
        {isGuestPurchase ? (
          <>
            <Text style={paragraph}>
              To access your kit&apos;s tutorials, tools, and community
              features, you&apos;ll need to claim your license. Click the button
            ...
            <Text style={smallText}>
              This claim link will work for 30 days. After claiming, you&apos;ll
              have full access to your kit&apos;s resources in your Workshop.
            </Text>
          </>
        ) : (
          <>
