  ...
  return (
    <BaseLayout preview={previewText}>
      ...
      <Text style={paragraph}>
        You recently purchased a {productName} from StarterSpark. To access
        your kit&apos;s tutorials, assembly guides, and community features,
        please claim your license by clicking the button below.
      </Text>
      ...
      <Section style={ctaSection}>
        ...
        <Text style={smallText}>
          Or copy this link: <Link href={claimUrl} style={link}>{claimUrl}</Link>
        </Text>
      </Section>
      ...
      <Section style={benefitsSection}>
        ...
        <Text style={benefitItem}>✓ Quick tools (Servo Calculator, Pinout Reference)</Text>
      </Section>
