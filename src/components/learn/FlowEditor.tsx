      ...
      <div className="grid lg:grid-cols-[240px_1fr_320px]">
        ...
        <div className="p-4 space-y-4">
          <div className="flex items-center justify-between gap-2">
            <p className="font-mono text-sm font-semibold text-slate-900">Inspector</p>
            <Button
              type="button"
              variant="outline"
              size="sm"
            ...
            <div className="space-y-4">
              ...
              {mode === "visual" && (
                <>
                  ...
                  <VisualParamsEditor node={selectedNode} onChange={updateSelectedParams} />
                </>
              )}
            </div>
          ) : (
          ...
          {mode === "visual" && generatedCode && (
            <>
              ...
              <div className="space-y-2">
                ...
                <CodeEditor initialCode={generatedCode} language="cpp" readOnly hideReset />
              </div>
            </>
          )}
        </div>
